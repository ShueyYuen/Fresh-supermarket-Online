      ...
      body: Column(
        children: <Widget>[
          ListTile(
            ...
            trailing: Transform.scale(scale: 1.5,child: Icon(Icons.navigate_next,size: 35,color: Colors.grey[400],),),
            subtitle: Title(color: Colors.grey, child: Text(user==null?"尚未登录":user.nickname)),
          ),
          ListTile(
          ...
          Container(
            ...
            child: FlatButton(
              ...
              onPressed: () {
                ...
                Provider.of<MyOrderModel>(context, listen: false).my_order = null;
              },
            ),
          )
        ],
