...
-- Records of goods
-- ----------------------------
INSERT INTO `goods` VALUES (1, '牛肉', '肉类蛋白', 'g', 60.00, '02', 90, '上海市奉贤区', '一包', '包', '冷藏', 500, 1, '产于奉贤某养牛场', '包邮，全程冷链运输，2.5小时内送达， 因交通情况派送或许有延迟。', '端午节期间专享产品，每人每天购买不超过一件，享受此优惠', 'hot', NULL);
